...
const About = () => {
  ...
  <div className="hero-content flex-col lg:flex-col gap-10 justify-between">
    ...
    <div>
        ...
        <h2 className="text-blue-600 text-xl md:text-4xl font-bold">I am Shahina Akter shima</h2>
    ...
    <div>
        <h2 className="md:text-3xl text-xl font-bold">Education:</h2>
    ...
    <div>
        <h2 className="md:text-3xl text-xl font-bold"> Skills:</h2>
        <p>I know about :
    ...
    <div>
        <h2 className="md:text-3xl text-xl font-bold"> Contact Info:</h2>
