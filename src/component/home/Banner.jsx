    ...
    return (
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            ...
            <p className="py-6 text-3xl font-bold ">Hello!!I am <span className="text-blue-600">Shahina Akter Shima</span></p>
            ...
            <div className="flex justify-between">
                <div>
                 <h2 className="text-3xl font-bold my-3 text-blue-600">Find me</h2>
                ...
                <div>
                 <h2 className="text-3xl font-bold my-3 text-blue-600">Best skills on</h2>
